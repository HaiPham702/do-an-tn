;(function (modules) {
  ...
  function (module, exports, __webpack_require__) {
    ...
    var PDFViewerApplication = {
                ...
                while (1) {
                  switch ((_context5.prev = _context5.next)) {
                    case 0:
                      ...
                      eventBus =
                        appConfig.eventBus || (0, _ui_utils.getGlobalEventBus)(dispatchToDOM)
      ...
      set page(val) {
        if (val == 1 && PDFViewerApplication.pdfViewer.spreadMode === 2) {
          viewerContainer.classList.add('singlePage')
          viewerContainer.classList.remove('paper')
        }
      ...
      error: function error(message, moreInfo) {
        var moreInfoText = [
          this.l10n.get(
            'error_version_info',
            { version: _pdfjsLib.version || '?', build: _pdfjsLib.build || '?' },
      ...
      load: function load(pdfDocument) {
        ...
        pdfDocument.getMetadata().then(function (_ref5) {
          ...
          var contentDispositionFilename = _ref5.contentDispositionFilename
      ...
      _initializePdfHistory: function _initializePdfHistory(_ref6) {
        ...
        var viewOnLoad = _ref6.viewOnLoad
        var _ref6$initialDest = _ref6.initialDest
        var initialDest = _ref6$initialDest === void 0 ? null : _ref6$initialDest
      ...
      setInitialView: function setInitialView(storedHash) {
        ...
        var sidebarView = _ref7.sidebarView
        var scrollMode = _ref7.scrollMode
        var spreadMode = _ref7.spreadMode
    ...
    function loadAndEnablePDFBug(enabledTabs) {
      ...
      return (0, _pdfjsLib.loadScript)(appConfig.debuggerScriptPath).then(function () {
        ...
        PDFBug.init(
          { OPS: _pdfjsLib.OPS, createObjectURL: _pdfjsLib.createObjectURL },
    ...
    function webViewerInitialized() {
      ...
      // file = decodeURIComponent(escape(atob(file)))
      ...
      if (mobileCheck()) {
        PDFViewerApplication.pdfSidebarResizer.doc.style.setProperty(SIDEBAR_WIDTH_VAR, '100%')
      }
    ...
    function webViewerNextPage() {
      webViewerNextPaperPage()
    }
    function webViewerPreviousPage() {
      webViewerPreviousPaperPage()
    }
    function webViewerNextPaperPage() {}
    function webViewerPreviousPaperPage() {}
    function setPositionSinglePage() {
  ...
  function (module, exports, __webpack_require__) {
    ...
    var PresentationModeState = { UNKNOWN: 0, NORMAL: 1, CHANGING: 2, FULLSCREEN: 3 }
    exports.PresentationModeState = PresentationModeState
    var RendererType = { CANVAS: 'canvas', SVG: 'svg' }
    exports.RendererType = RendererType
    var TextLayerMode = { DISABLE: 0, ENABLE: 1, ENABLE_ENHANCE: 2 }
    exports.TextLayerMode = TextLayerMode
    var ScrollMode = { UNKNOWN: -1, VERTICAL: 0, HORIZONTAL: 1, WRAPPED: 2, FLIP: 3 }
    ...
    var EventBus = (function () {
      function EventBus() {
        ...
        var _ref3$dispatchToDOM = _ref3.dispatchToDOM
        var dispatchToDOM = _ref3$dispatchToDOM === void 0 ? false : _ref3$dispatchToDOM
    ...
    GrabToPan.prototype = {
      ...
      _onmousemove: function GrabToPan__onmousemove(event) {
        ...
        if (this.element.scrollTo) {
          this.element.scrollTo({ top: scrollTop, left: scrollLeft, behavior: 'instant' })
        } else {
  ...
  function (module, exports, __webpack_require__) {
    ...
    var SidebarView = { UNKNOWN: -1, NONE: 0, THUMBS: 1, OUTLINE: 2, ATTACHMENTS: 3, LAYERS: 4 }
      ...
      _createClass(PDFSidebar, [
        ...
        },
        {
          ...
          value: function setInitialView() {
            var view =
              arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : SidebarView.NONE
        ...
        },
        {
          ...
          value: function toggle() {
            var previousPaperBt = document.getElementById('previous-paper').classList
            if (this.isOpen) {
              this.close()
              previousPaperBt.remove('sidebar-toggle')
            } else {
              this.open()
              previousPaperBt.add('sidebar-toggle')
            }
          }
        },
        {
  ...
  function (module, exports, __webpack_require__) {
    ...
    var defaultOptions = {
      ...
      externalLinkRel: { value: 'noopener noreferrer nofollow', kind: OptionKind.VIEWER },
      ...
      spreadModeOnLoad: { value: 0, kind: OptionKind.VIEWER },
        ...
        },
        {
          ...
          value: function _appendAttachment(_ref3) {
            ...
            this._renderedCapability.promise.then(function () {
              ...
              attachments[id] = { filename: filename, content: content }
              _this2.render({ attachments: attachments, keepRenderedCapability: true })
            })
          }
        }
      ])
        ...
        },
        {
          ...
          value: function _parsePageSize(pageSizeInches, pagesRotation) {
            ...
            if (pagesRotation % 180 !== 0) {
              pageSizeInches = { width: pageSizeInches.height, height: pageSizeInches.width }
            }
  ...
  function (module, exports, __webpack_require__) {
    ...
    var PDFFindController = (function () {
      function PDFFindController(_ref) {
        ...
        var eventBus = _ref$eventBus === void 0 ? (0, _ui_utils.getGlobalEventBus)() : _ref$eventBus
      ...
      _createClass(PDFFindController, [
        ...
        },
        {
          ...
          value: function scrollMatchIntoView(_ref2) {
            ...
            var spot = { top: MATCH_SCROLL_OFFSET_TOP, left: MATCH_SCROLL_OFFSET_LEFT }
      ...
      _createClass(PDFHistory, [
        {
          ...
          value: function initialize(_ref2) {
            ...
            if (!this._isValidState(state, true) || resetHistory) {
              ...
              this._pushOrReplaceState({ hash: hash, page: page, rotation: rotation }, true)
              return
            }
        ...
        },
        {
          ...
          value: function push(_ref3) {
            ...
            if (namedDest && typeof namedDest !== 'string') {
              console.error(
                'PDFHistory.push: ' + '"'.concat(namedDest, '" is not a valid namedDest parameter.')
              )
              return
          ...
          value: function setHash(hash) {
            ...
            if (hash.includes('=')) {
              ...
              if ('pagemode' in params) {
                this.eventBus.dispatch('pagemode', { source: this, mode: params.pagemode })
              }
            } else {
              dest = unescape(hash)
              try {
      ...
      _createClass(PDFOutlineViewer, [
        ...
        },
        {
          ...
          value: function _dispatchEvent(outlineCount) {
            this.eventBus.dispatch('outlineloaded', { source: this, outlineCount: outlineCount })
          }
        },
        {
          key: '_bindLink',
  ...
  function (module, exports, __webpack_require__) {
    ...
    var PDFPresentationMode = (function () {
      function PDFPresentationMode(_ref) {
        ...
        var viewer = _ref$viewer === void 0 ? null : _ref$viewer
  ...
  function (module, exports, __webpack_require__) {
    ...
    var THUMBNAIL_SCROLLX_MARGIN = -19
        ...
        },
        {
          ...
          value: function scrollThumbnailIntoView(pageNumber) {
            ...
            if (numVisibleThumbs > 0) {
              ...
              if (shouldScroll) {
                var paramScroll = { top: THUMBNAIL_SCROLL_MARGIN }
                if (mobileCheck()) {
                  paramScroll = { left: THUMBNAIL_SCROLLX_MARGIN }
                }
                ;(0, _ui_utils.scrollIntoView)(thumbnailView.div, paramScroll)
              }
            }
  ...
  function (module, exports, __webpack_require__) {
    ...
    var PDFThumbnailView = (function () {
      function PDFThumbnailView(_ref) {
        ...
        ring.style.height = this.canvasHeight + borderAdjustment + 12 + 'px'
        this.ring = ring
        div.appendChild(ring)
        if (!mobileCheck()) {
          var pageNum = document.createElement('div')
          pageNum.className = 'page-num'
          pageNum.innerText = this.id
        ...
        [
          ...
          },
          {
            ...
            value: function setPageLabel(label) {
              ...
              this.l10n
                .get('thumb_page_title', { page: this.pageId }, 'Trang {{page}}')
                .then(function (msg) {
      ...
      _createClass(BaseViewer, [
        ...
        },
        {
          ...
          value: function setDocument(pdfDocument) {
            ...
            pagesCapability.promise.then(function () {
              ...
              _this2.eventBus.dispatch('pagesloaded', { source: _this2, pagesCount: pagesCount })
            })
            ...
            firstPagePromise
              .then(function (pdfPage) {
                ...
                var viewport = pdfPage.getViewport({ scale: scale * _ui_utils.CSS_UNITS })
                for (var pageNum = 1; pageNum <= pagesCount; ++pageNum) {
        ...
        },
        {
          ...
          value: function _resetView() {
            ...
            this._spreadMode = _ui_utils.SpreadMode.EVEN
        ...
        },
        {
          ...
          value: function _setScale(value) {
            ...
            if (scale > 0) {
              ...
              var pageWidthScale =
                (this.container.clientWidth / currentPage.width) * currentPage.scale
              var pageHeightScale =
                ((this.container.clientHeight - vPadding - 8) / currentPage.height) *
                currentPage.scale
              _ui_utils.MIN_SCALE = pageHeightScale
              switch (value) {
                case 'page-actual':
                  scale = 1
                  break
        ...
        },
        {
          ...
          value: function scrollPageIntoView(_ref3) {
            ...
            if (scale === 'page-fit' && !destArray[4]) {
              this._scrollIntoView({ pageDiv: pageView.div, pageNumber: pageNumber })
              return
            }
            var boundingRect = [
        ...
        },
        {
          ...
          value: function isPageVisible(pageNumber) {
            ...
            if (this.pageNumber < 1 || pageNumber > this.pagesCount) {
              console.error(
                ''.concat(this._name, '.isPageVisible: "').concat(pageNumber, '" is out of bounds.')
              )
              return false
            }
        ...
        },
        {
          ...
          value: function createAnnotationLayerBuilder(pageDiv, pdfPage) {
            ...
            var renderInteractiveForms =
              arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false
            var l10n =
              arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : _ui_utils.NullL10n
        ...
        },
        {
          ...
          set: function set(val) {
            ...
            if (!this._setCurrentPageNumber(val, true)) {
              console.error(
                ''.concat(this._name, '.currentPageNumber: "').concat(val, '" is not a valid page.')
              )
            }
          }
        },
        {
          ...
          set: function set(val) {
            ...
            if (!this._setCurrentPageNumber(page, true)) {
              console.error(
                ''.concat(this._name, '.currentPageLabel: "').concat(val, '" is not a valid page.')
              )
            }
          }
        },
      ...
      function SecondaryToolbar(options, mainContainer, eventBus) {
        ...
        this.buttons = [
          ...
          { element: options.lastPageButton, eventName: 'lastpage', close: true },
          {
            ...
            eventDetails: { mode: _ui_utils.ScrollMode.FLIP },
            close: true
          },
          {
        ...
        this.items = { firstPage: options.firstPageButton, lastPage: options.lastPageButton }
        ...
        },
        {
          ...
          value: function _bindClickListeners() {
            ...
            var _loop = function _loop(button) {
              ...
              var element = _this2$buttons$button.element
              var eventName = _this2$buttons$button.eventName
              var close = _this2$buttons$button.close
              var eventDetails = _this2$buttons$button.eventDetails
  ...
  function (module, exports, __webpack_require__) {
    ...
    var PDFSinglePageViewer = (function (_BaseViewer) {
      ...
      _createClass(PDFSinglePageViewer, [
        ...
        },
        {
          ...
          value: function _scrollIntoView(_ref) {
            ...
            _get(_getPrototypeOf(PDFSinglePageViewer.prototype), '_scrollIntoView', this).call(
              this,
              { pageDiv: pageDiv, pageSpot: pageSpot, pageNumber: pageNumber }
            )
        ...
        { key: '_updateHelper', value: function _updateHelper(visiblePages) {} },
        { key: '_updateScrollMode', value: function _updateScrollMode() {} },
        { key: '_updateSpreadMode', value: function _updateSpreadMode() {} },
        {
          key: '_setDocumentViewerElement',
          get: function get() {
          ...
          value: function _updateUIState() {
            ...
            if (resetNumPages) {
              if (this.hasPageLabels) {
                ...
                this.l10n
                  .get('of_pages', { pagesCount: pagesCount }, '/ {{pagesCount}}')
                  .then(function (msg) {
            ...
            if (pageScale <= _ui_utils.MIN_SCALE) {
              PDFViewerApplication.pdfCursorTools.switchTool(0)
              document.getElementsByClassName('wrapViewer')[0].classList.remove('unset-overflow')
            } else {
              PDFViewerApplication.pdfCursorTools.switchTool(1)
              document.getElementsByClassName('wrapViewer')[0].classList.add('unset-overflow')
            }
...
function stopReading() {
  ...
  if (currentPage === PDFViewerApplication.pagesCount) {
    currentPage = 0
  }
  if (
    !isSinglePageViewMode() &&
    PDFViewerApplication.pagesCount % 2 === 1 &&
    currentPage == PDFViewerApplication.pagesCount - 1
  ) {
    currentPage = 0
  }
...
window.addEventListener('message', function (event) {
  switch (event.data.type) {
    case 'toPage':
      ...
      inputElement.value = event.data.currentPage
